...
def run_verification():
    ...
    chrome_options.add_argument("--use-gl=swiftshader") # Try to force software rendering
    ...
    try:
        ...
        driver.save_screenshot("/home/jules/verification/celebration_verification_gl.png")
